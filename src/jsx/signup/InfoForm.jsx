...
export default function InfoForm() {
  ...
  const FACULTIES = useMemo(
    () => [
      ...
      { name: "항공융합학부", majors: ["항공컴퓨터학과","호텔카지노관광학과","식품공학과","항공의료학과","국제관계학과","신소재화학공학과","환경·토목·건축학과","전기전자공학과"] },
  ...
  const allChosen =
    isAxisChosen(axes.ie) && isAxisChosen(axes.ns) &&
    isAxisChosen(axes.ft) && isAxisChosen(axes.pj);
        ...
        <form className="info-form" onSubmit={handleSubmit} noValidate>
          ...
          <div className="field">
            ...
            <div className="hint-box" role="status" aria-live="polite">
              ...
              {dupState === "checking" && <span className="hint-info">중복 확인 중…</span>}
              {dupState === "ok" && nickname.trim().length >= 2 && (
                <span className="hint-success">사용 가능한 닉네임이에요.</span>
              )}
              {dupState === "taken" && <span className="hint-error">중복된 닉네임입니다.</span>}
              {dupState === "error" && (
                <span className="hint-error">확인에 실패했어요. 잠시 후 다시 시도해주세요.</span>
              )}
            </div>
          </div>
          ...
          <div className="grid-3">
            ...
            <div className="field">
              ...
              <div className="hint-box1">
                {isYearInvalid && <span className="hint-error">학번을 확인해주세요.</span>}
              </div>
            </div>
          ...
          <div className="field">
            <label className="field-label" htmlFor="mbtiBtn">MBTI</label>
            <div
              id="mbtiBtn"
              role="button"
            ...
            >
              <span className="text-input as-text">{mbti || "슬라이더로 MBTI를 선택하세요."}</span>
          ...
          <div className="field">
            ...
            >
              <span className="text-input as-text">{major || "학과를 선택하세요."}</span>
              <span className="chev" aria-hidden>▾</span>
            </div>
          </div>
        ...
        <>
          ...
          <div className="sheet-panel">
            <div className="sheet-header">
              ...
              <button className="sheet-close" type="button" onClick={() => setSheetOpenMbti(false)}>✕</button>
            </div>
            <div className="sheet-body">
