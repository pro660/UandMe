...
const DEFAULT_QUESTIONS = [
  { id: 1, text: "첫만남에서의 당신, 주로 어떤 상황을 선호하시나요?", options: ["사람들과 함께하는 편안하고 시끌벅적한 모임", "조용하고 분위기 있는 카페에서 일대일 대화"] },
  { id: 2, text: "데이트 상대를 볼 때, 가장 중요하게 생각하는 것은?", options: ["유머러스하고 즐거운 시간을 보내 수 있는 사람", "진지하고 깊이 있는 대화를 나눌 수 있는 사람"] },
  { id: 3, text: "첫 인사할 때, 어떤 모습일까요?", options: ["조심스럽게 인사하기", "눈 마주치며 당당하게 인사하기"] },
  { id: 4, text: "갈등 상황에서 당신은?", options: ["회피하기보단 직접적으로 소통하고 해결하려한다.", "상대의 의견을 먼저 듣고 배려하며 부드럽게 대처한다."] },
  { id: 5, text: "당신의 외적 이상형에 더 가까운 것은?", options: ["힙하고 트렌디한 스타일", "깔끔하고 단정한 스타일"] },
  { id: 6, text: "어떤 데이트를 선호하나요?", options: ["즉흥적이고 계획되지 않은 데이트", "미리 준비한 안정적인 데이트"] },
  { id: 7, text: "애정 표현 방식은 주로 어떤가요?", options: ["솔직하고 직접적", "은은하고 섬세함"] },
  { id: 8, text: "관계에서 당신이 추구하는 가장 큰 가치는 무엇인가요?", options: ["서로에게 새로운 활력을 불어넣는 흥미로움", "편안한 신뢰를 바탕으로 한 안정감"] },
  { id: 9, text: "호감이 있는 사람이랑 데이트 중 손이 닿았을 때, 어떻게 할건가요?", options: ["자연스럽게 손 잡기", "작게 웃으며 눈치만 보기"] },
  { id: 10, text: "데이트 상대와 있을 때, 당신의 모습은?", options: ["재미있는 분위기를 주도하고 리드하는 편", "상대방의 이야기에 귀 기울이고 맞춰주는 편"] },
];
...
function QPageInner({ questions, baseInfo }) {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const qPayload = Object.fromEntries(ab.map((ans, i) => [`q${i + 1}`, ans]));
