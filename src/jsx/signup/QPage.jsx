...
const DEFAULT_QUESTIONS = [
  ...
  },
  {
    ...
    options: ["유머러스하고 즐거운 시간을 보내 수 있는 사람", "진지하고 깊이 있는 대화를 나눌 수 있는 사람"],
  },
  { id: 3, text: "첫 인사할 때, 어떤 모습일까요?", options: ["조심스럽게 인사하기", "눈 마주치며 당당하게 인사하기"] },
  {
    id: 4,
    text: "갈등 상황에서 당신은?",
    options: ["회피하기보단 직접적으로 소통하고 해결하려한다.", "상대의 의견을 먼저 듣고 배려하며 부드럽게 대처한다."],
  },
  ...
  return (
    <div className="qpage">
      ...
      <div className="qpage-top">
        ...
        <div className="qpage-progress" role="progressbar" aria-valuemin={0} aria-valuemax={TOTAL} aria-valuenow={step + 1}>
      ...
      {/* 확인 버튼 */}
      <button className="qpage-confirm" onClick={handleConfirm} disabled={choice === null || submitting} type="button">
