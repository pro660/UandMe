...
const DEFAULT_QUESTIONS = [
  ...
  { id: 2, text: "데이트 상대를 볼 때, 가장 중요하게 생각하는 것은?",
    options: ["유머러스하고 즐거운 시간을 보내 수 있는 사람", "진지하고 깊이 있는 대화를 나눌 수 있는 사람"] },
  { id: 3, text: "첫 인사할 때, 어떤 모습일까요?",
    options: ["작게 웃으면서 고개 숙이기", "먼저 다가가서 밝게 인사하기"] },
  { id: 4, text: "갈등 상황에서 당신은?",
    options: ["회피하기보단 직접적으로 소통하고 해결하려한다.", "상대의 의견을 먼저 듣고 배려하며 부드럽게 대처한다."] },
  { id: 5, text: "당신의 외적 이상형에 더 가까운 것은?",
    options: ["힙하고 트렌디한 스타일", "깔끔하고 단정한 스타일"] },
  { id: 6, text: "어떤 데이트를 선호하나요?",
  ...
  { id: 9, text: "호감이 있는 사람이랑 데이트 중 손이 닿았을 때, 어떻게 할건가요?",
